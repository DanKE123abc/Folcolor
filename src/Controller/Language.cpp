...
static const wchar_t* langStrings[LANG_COUNT][LANG_STRING_COUNT] =
{
    ...
    },
    {
        ...
        L"フォルダを削除してください。",
        L"中止：",
        L"Folcolor は特殊フォルダ（ダウンロード、ドキュメント、音楽など）と判断する可能性があり、復元が複雑なためサポートされていません。",
...
{
    if (lang < 0 || lang >= LANG_COUNT || stringId < 0 || stringId >= LANG_STRING_COUNT)
